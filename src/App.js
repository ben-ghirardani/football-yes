...
export default class App extends Component {
  ...
  fetchMatches() {
    ...
    fetch('https://gallant-hawking-a37956.netlify.app/.netlify/functions/fetchMatches',
  ...
  fetchStandings() {
    // specify header rather than '*' ?
    fetch('https://gallant-hawking-a37956.netlify.app/.netlify/functions/fetchStandings', {headers: {'Access-Control-Allow-Origin': '*'}})
      .then(response => response.json())
